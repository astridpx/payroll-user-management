        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="payroll-card">
                    <h5 class="mb-4 payroll-heading">Monitoring Details</h5>
                    <div class="row">
                        <div class="col-md-6">
							<p><strong>Monitoring Ref:</strong> <?php echo $pay['ref_no'] ?></p>
                            <p><strong>Employee ID:</strong> <?php echo $employee_no ?></p>
                            <p><strong>Name:</strong> <?php echo ucwords($ename) ?></p>
                            
                            <p><strong>Date Range:</strong> <?php echo date("M d, Y", strtotime($pay['date_from'])) . " - " . date("M d, Y", strtotime($pay['date_to'])) ?></p>
                            <!-- <p><strong>Payroll Type:</strong> <?php echo $pt[$pay['type']] ?></p> -->
                        </div>
                        <div class="col-md-6">
                            
                            <p><strong>Tardy/Late (mins):</strong> <?php echo $lates?></p>
                            <p><strong>Absences :</strong> <?php echo $absents?></p>
