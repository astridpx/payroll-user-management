<style>
  ...
  .sidebar-sticky {
    ...
    padding-top: 0.5rem;
    overflow-x: hidden;
      overflow-y: auto; /* SCROLLABLE VIEW POINT. */
    }
</style>
...
<header>
  ...
  <nav id="sidebarMenu" class="collapse d-lg-block sidebar collapse bg-white">
      ...
      <div class="list-group list-group-flush mx-3 mt-4">
        ...
        <a href="index.php?page=payroll" class="list-group-item list-group-item-action py-2 ripple nav-payroll"><i
            class="fas fa-money-check-alt fa-fw me-3"></i><span>Payroll</span></a>
        <a href="index.php?page=employee" class="list-group-item list-group-item-action py-2 ripple nav-employee"><i
            class="fas fa-users fa-fw me-3"></i><span>Employee list</span></a>
        ...
        <a href="index.php?page=position" class="list-group-item list-group-item-action py-2 ripple nav-position"><i
            class="fas fa-briefcase fa-fw me-3"></i><span>Position</span></a>
        <a href="index.php?page=allowances" class="list-group-item list-group-item-action py-2 ripple nav-allowances"><i
            class="fas fa-wallet fa-fw me-3"></i><span>Allowance</span></a>
        <a href="index.php?page=deductions" class="list-group-item list-group-item-action py-2 ripple nav-deductions"><i
            class="fas fa-file-invoice-dollar fa-fw me-3"></i><span>Deduction</span></a>

        <a href="index.php?page=schedule" class="list-group-item list-group-item-action py-2 ripple nav-schedule"><i
            class="fas fa-calendar-alt fa-fw me-3"></i><span>Schedule</span></a>
        <a href="index.php?page=user" class="list-group-item list-group-item-action py-2 ripple nav-user"><i
            class="fas fa-user fa-fw me-3"></i><span>User</span></a>
      </div>
    </div>
  </nav>
      ...
      <ul class="navbar-nav ms-auto d-flex flex-row">
        ...
        <li class="nav-item dropdown>
          <a class="nav-link dropdown-toggle hidden-arrow d-flex align-items-center" href="#"
            ...
            <img style="color: white" src="https://mdbcdn.b-cdn.net/img/Photos/Avatars/img (31).webp" class="rounded-circle"
